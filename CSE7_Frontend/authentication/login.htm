...
<body>
        <div class="glass-parent">
            ...
            <div class="frame-group">
                ...
                <form id="loginUserForm" class="frame-container" name="loginUserForm" method="post">
                <div class="frame-div">
                    <div class="username-parent">
                    <div class="username">Email</div>
                    <input type="email" name="email" id="userEmail" class="enter-your-email-wrapper" placeholder="Enter your email" required>
                    </div>
                    <div class="password-parent">
                    <div class="password">Password</div>
                    <input type="password" name="password" id="userPassword" class="enter-your-password-wrapper" placeholder="Enter your password" required>
                    </div>
                    <!-- Optional: A field for the name -->
                    
                </div>
                <button type="submit" class="sign-up-wrapper">
                    <div class="sign-up">Log in</div>
                </button>
                </form>
            </div>
            ...
            <div class="social-media-parent">
                ...
                <div class="google-container">
                    ...
                    <button class="google" id="googleCustomButton_login">
